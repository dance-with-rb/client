  ...
  <div class="login h-screen">
    ...
    >
      <div class="mb-6">
        ...
        <h1 class="text-green-500 text-xl font-bold tracking-tighter">
          따릉따릉따릉이 관리자
        </h1>
      </div>
      <form>
        <div class="flex flex-col items-center">
          <div class="flex flex-col items-start mb-6">
            <label>아이디</label>
            <Input type="text" large v-model="username" />
          </div>
          <div class="flex flex-col items-start mb-6">
            <label>비밀번호</label>
            <Input type="password" large v-model="password" />
          </div>
          <Button text="로그인" primary fluid />
        </div>
      </form>
      <div
        class="mt-6 underline cursor-pointer hover:text-green-500 hover:font-bold"
      >
