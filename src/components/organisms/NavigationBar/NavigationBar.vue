<template>
  <div name="navigation-bar" class="navigation-bar">
    <div class="navigation-bar__logo-wrapper">
      ...
      <p class="navigation-bar__title">따릉따릉따릉이</p>
    </div>
...
.navigation-bar {
  @apply h-20 w-full bg-green-500 flex items-center justify-between px-12 select-none;
}
...
.navigation-bar__username-wrapper {
  @apply w-12 h-12 bg-white rounded-full flex items-center justify-center;
}

.navigation-bar__username {
  @apply text-green-500 font-bold uppercase relative cursor-pointer;
}

.navigation-bar__dropdown {
  @apply absolute top-24 bg-white border border-gray-200;
}
...
export default class NavigationBar extends Vue {
  ...
  @Prop({ type: Function }) private onLogout!: () => void;
